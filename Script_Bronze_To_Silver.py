...
DropDuplicates_node1744048898074 =  DynamicFrame.fromDF(Bronze_node1744048860746.toDF().dropDuplicates(), glueContext, "DropDuplicates_node1744048898074")
...
from  myDataSource
where hora_nascimento IS NOT NULL


'''
SelecionandoColunas_node1744049807297 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"myDataSource":DropDuplicates_node1744048898074}, transformation_ctx = "SelecionandoColunas_node1744049807297")
